...
lData = open_url("https://raw.githubusercontent.com/Infihnity3/CPS/main/historical-price/ADA-USD.csv")
...
plt.title('Prediction of Closing Price for Cardano-USD')
plt.xlabel('Days')
plt.ylabel('Price')
...
pyscript.write("plot",fig)
    ...
    <!-- <p class="container">Prediction Results of Cardano-USD</p> -->
    <div class="container">
