...
lData = open_url("https://raw.githubusercontent.com/Infihnity3/CPS/main/historical-price/BCH-USD.csv")
...
plt.title('Prediction of Closing Price for Bitcoin Cash-USD')
plt.xlabel('Days')
plt.ylabel('Price')
