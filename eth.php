...
lData = open_url("https://raw.githubusercontent.com/Infihnity3/CPS/main/historical-price/ETH-USD.csv")
...
plt.title('Prediction of Closing Price for Ethereum-USD')
plt.xlabel('Days')
plt.ylabel('Price')
...
pyscript.write("plot",fig)
    ...
    <!-- <p class="container">Prediction Results of Ethereum-USD</p> -->
    <div class="container">
