...
lData = open_url("https://raw.githubusercontent.com/Infihnity3/CPS/main/historical-price/SOL-USD.csv")
...
plt.title('Prediction of Closing Price for Solana-USD')
plt.xlabel('Days')
plt.ylabel('Price')
...
pyscript.write("plot",fig)
    ...
    <!-- <p class="container">Prediction Results of Solana-USD</p> -->
    <div class="container">
