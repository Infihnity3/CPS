...
lData = open_url("https://raw.githubusercontent.com/Infihnity3/CPS/main/historical-price/XRP-USD.csv")
...
plt.title('Prediction of Closing Price for Ripple-USD')
plt.xlabel('Days')
plt.ylabel('Price')
...
pyscript.write("plot",fig)
    ...
    <!-- <p class="container">Prediction Results of Ripple Coin-USD</p> -->
    <div class="container">
